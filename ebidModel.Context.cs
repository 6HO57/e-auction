...
namespace e_auction.Models
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> save_tender(Nullable<int> tenderid, Nullable<int> clientId, string tenderDesc, string filename, Nullable<System.DateTime> startdate, string startTime, Nullable<int> timePeriodId, Nullable<int> company, Nullable<int> status)
        {
            var tenderidParameter = tenderid.HasValue ?
                new ObjectParameter("Tenderid", tenderid) :
                new ObjectParameter("Tenderid", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("save_tender", tenderidParameter, clientIdParameter, tenderDescParameter, filenameParameter, startdateParameter, startTimeParameter, timePeriodIdParameter, companyParameter, statusParameter);
        }
